classdef LQG_agent < translating_agent_2D
% Class: LQG_agent < translating_agent_2D < agent
%
% Description
    ...
    properties        
        ...
        integrator_type = 'ode4' ; % choose 'ode45' or 'ode4' or 'ode113'
        integrator_time_discretization = 0.01 ; % for ode4
    end
    
    methods
        %% constructor
        function A = LQG_agent(varargin)
