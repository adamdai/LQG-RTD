% For discrete LQG system, generate FRS over a space of trajectory
% parameters and save it as .mat file
...
save('LQG_FRS.mat','pXrs','Xrs','dt','t_f');

%% create obstacle and intersect with FRS
obs_center = [1.0; 0];
obs_gen = [[0.4; 0], [0.2; 0.6]];
...
figure(1);
for i = 1:length(Xrs)
    p_slice = plot(zonotope_slice(Xrs{i}, k_dim, [k1_user; k2_user]), [1, 2], 'Color','k');
