...
% X0 = [x_0; % initial (x,y) position
%       xh_0; % initial (x,y) estimate
...
%       x_nom_0 % initial (x,y) position of nominal trajectory 
...
options.x0 = [x_0; xh_0; vec(P_0); k1c; k2c; x_nom_0]; % center of initial set
options.R0 = zonotope([options.x0, [zeros(8,1);k1g;zeros(3,1)], [zeros(9,1);k2g;zeros(2,1)]]); % generators for parameter dimensions
...
sys = nonlinearSysDT(dim,1,@aug_LQG_DT,options);
