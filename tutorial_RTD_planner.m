classdef tutorial_RTD_planner < planner
    properties
        FRS
    ...
    methods
        function P = tutorial_RTD_planner(varargin)
            name = 'Tutorial RTD planner' ;
        ...
        function setup(P,agent_info,world_info)
            ...
            B = [B, nan(2,1), 1.01.*B(:,end:-1:1)] ; % why nan(2,1)?
            ...
            for idx = 1:3
                ...
                k = P.FRS{idx}.k ;
                % how does this work?
                % I is indicator function, z is (x,y), k is traj params
                % (k1,k2)
        ...
        function [T,U,Z] = replan(P,agent_info,world_info)
            ...
            k_2_lo = (v_des_lo - v_max/2)*(2/v_max) ;  % computing acceleration?
